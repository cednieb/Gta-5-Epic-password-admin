...
:epickill
C:\Windows\System32\runas.exe /user:%computername%\%Admin% /savecred  "taskkill /IM \"EpicGamesLauncher.exe\" /F"
goto :choices
...
echo Wait 5 seconds 
timeout 5 > NUL
C:\Windows\System32\runas.exe /user:%computername%\%Admin% /savecred "G:\Epic Games\Launcher\Portal\Binaries\Win32\EpicGamesLauncher.exe"
goto :choices
